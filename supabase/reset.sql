-- Reset script: Clears existing data and restores all sample threads
...
-- Step 3: Insert messages for all threads
...
-- Done! You should now have 10 threads with all their messages.
SELECT 'Reset complete! You now have ' || COUNT(*) || ' threads.' as result FROM threads;
